...
task = Task.init(
    ...
    task_name="DeepSeek-R1-Distill-Llama-32B Inference",
...
with open('inference_results_deepseek.json', 'w', encoding='utf-8') as f:
    json.dump(results, f, ensure_ascii=False, indent=2)

task.upload_artifact(
    name="deepseek_inference_test",
    artifact_object="inference_results_deepseek.json"
)
print(f"Done")